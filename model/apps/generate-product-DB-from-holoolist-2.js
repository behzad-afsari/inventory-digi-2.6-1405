...
const generateProductListFromHoloo = () => {
    ...
    const excelHoloo = behzad.readXLSX(path.join(__dirname, "../data/list-products-from-holoo/list-holoo"),"Sheet1");
    // console.log('---excle holoo----',excelHoloo);
    let i = 1
    excelHoloo.map(item => {
...
const lllist = generateProductListFromHoloo()
